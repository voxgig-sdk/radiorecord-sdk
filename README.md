...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/radiorecord` | `npm install @voxgig-sdk/radiorecord` |
| Python | `voxgig-sdk-radiorecord` | `pip install voxgig-sdk-radiorecord` |
| PHP | `voxgig-sdk/radiorecord` | `composer require voxgig-sdk/radiorecord` |
| Golang | `github.com/voxgig-sdk/radiorecord-sdk/go` | `go get github.com/voxgig-sdk/radiorecord-sdk/go` |
| Ruby | `voxgig-sdk-radiorecord` | `gem install voxgig-sdk-radiorecord` |
| Lua | `voxgig-sdk-radiorecord` | `luarocks install voxgig-sdk-radiorecord` |
