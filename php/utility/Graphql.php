...
// Radiorecord SDK utility: graphql
//
...
class RadiorecordGraphql
{
    ...
    // equivalent.
    public static function body(RadiorecordContext $ctx): mixed
    {
    ...
    public static function errors(RadiorecordContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
