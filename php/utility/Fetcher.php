...
// Radiorecord SDK utility: fetcher

class RadiorecordFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RadiorecordSDK/1.0)';
    ...
    public static function call(RadiorecordContext $ctx, string $fullurl, array $fetchdef): array
    {
