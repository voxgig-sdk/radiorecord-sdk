# Radiorecord PHP SDK Reference

Complete API reference for the Radiorecord PHP SDK.
...
#### `RadiorecordSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): RadiorecordUtility`
