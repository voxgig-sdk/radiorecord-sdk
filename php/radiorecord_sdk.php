...
class RadiorecordSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = RadiorecordHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = RadiorecordHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!RadiorecordFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, RadiorecordFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return RadiorecordUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = RadiorecordHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = RadiorecordHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = RadiorecordHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new RadiorecordError($op . "_allow",
                "RadiorecordSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = RadiorecordHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new RadiorecordError("graphql_error",
                "RadiorecordSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Chart($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_chart === null) {
                $this->_chart = new ChartEntity($this, null);
            }
            return $this->_chart;
        }
        return new ChartEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new RadiorecordSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
