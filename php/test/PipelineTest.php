...
{
    private static function utility(): RadiorecordUtility
    {
        return new RadiorecordUtility();
    }
    ...
    private static function ctx(array $over = []): RadiorecordContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RadiorecordContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RadiorecordOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RadiorecordError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RadiorecordOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RadiorecordMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RadiorecordOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RadiorecordMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RadiorecordOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RadiorecordMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RadiorecordSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RadiorecordMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RadiorecordResponse([]),
            'result' => new RadiorecordResult([]),
        ]);
        [, $err] = RadiorecordMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RadiorecordSpec([]),
            'response' => null,
            'result' => new RadiorecordResult([]),
        ]);
        [, $err] = RadiorecordMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RadiorecordSpec(['step' => 's']),
            'response' => new RadiorecordResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RadiorecordResult([]),
        ]);
        [, $err] = RadiorecordMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RadiorecordSpec(['step' => 's']),
            'response' => new RadiorecordResponse(self::resp(200, ['v' => 1])),
            'result' => new RadiorecordResult([]),
        ]);
        [, $err] = RadiorecordMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RadiorecordSpec(['step' => 's']),
            'response' => new RadiorecordResponse(self::resp(200, ['v' => 2])),
            'result' => new RadiorecordResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RadiorecordMakeResponse::call($ctx);
    ...
    {
        $preset = new RadiorecordResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RadiorecordSpec([]),
            'response' => new RadiorecordResponse([]),
            'result' => new RadiorecordResult([]),
        ...
        [$got, $err] = RadiorecordMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RadiorecordResult([])]);
        [, $err] = RadiorecordMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RadiorecordSpec([]), 'result' => null]);
        [, $err] = RadiorecordMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RadiorecordSpec(['step' => 's']),
            'result' => new RadiorecordResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RadiorecordOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RadiorecordMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RadiorecordSpec(['step' => 's']),
            'result' => new RadiorecordResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RadiorecordOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RadiorecordMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RadiorecordResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RadiorecordSpec([]),
            'result' => new RadiorecordResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RadiorecordMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RadiorecordMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RadiorecordError('boom', 'boom');
        $utility->fetcher = function (RadiorecordContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RadiorecordSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RadiorecordMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RadiorecordContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RadiorecordMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RadiorecordResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        RadiorecordMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RadiorecordContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RadiorecordSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RadiorecordMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RadiorecordResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RadiorecordSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RadiorecordMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RadiorecordMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RadiorecordMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RadiorecordResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RadiorecordDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RadiorecordResult(['ok' => false])]);
        $this->expectException(RadiorecordError::class);
        RadiorecordDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RadiorecordResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RadiorecordMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RadiorecordMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RadiorecordBaseFeature();
        $b = new RadiorecordBaseFeature();
        RadiorecordFeatureAdd::call($ctx, $a);
        RadiorecordFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RadiorecordBaseFeature
    {
        $f = new RadiorecordBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RadiorecordFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RadiorecordContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RadiorecordSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RadiorecordPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        RadiorecordPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RadiorecordResponse(['headers' => null]),
            'result' => new RadiorecordResult([]),
        ]);
        RadiorecordResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        RadiorecordResultBody::call($ctx);
