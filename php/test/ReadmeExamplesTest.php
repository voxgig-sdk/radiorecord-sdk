...
// Radiorecord SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RadiorecordSDK::test)
...
{
    private const SDK_CLASS = 'RadiorecordSDK';
    ...
    private const SDK_BASE = 'radiorecord_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../radiorecord_sdk.php';
