...
class RadiorecordTestRunner
{
    ...
    {
        $live = self::getenv('RADIORECORD_TEST_LIVE');
        $override = self::getenv('RADIORECORD_TEST_OVERRIDE');
        ...
        $explain = self::getenv('RADIORECORD_TEST_EXPLAIN');
...
class_alias('RadiorecordTestRunner', 'Runner');
class_alias('RadiorecordHelpers', 'Helpers');
