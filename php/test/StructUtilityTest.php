...
// Radiorecord SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = RadiorecordOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(RadiorecordOmni::structfix($now, Struct::undef()))
                        !== json_encode(RadiorecordOmni::structfix($val, Struct::undef()))) {
