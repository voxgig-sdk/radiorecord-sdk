...
// Radiorecord SDK clienttrack feature
...
class RadiorecordClienttrackFeature extends RadiorecordBaseFeature
{
    ...
    public function PostConstruct(RadiorecordContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Radiorecord-SDK';
