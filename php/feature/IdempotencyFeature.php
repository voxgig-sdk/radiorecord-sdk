...
// Radiorecord SDK idempotency feature
...
class RadiorecordIdempotencyFeature extends RadiorecordBaseFeature
{
    ...
    private function _mutating(RadiorecordContext $ctx): bool
    {
