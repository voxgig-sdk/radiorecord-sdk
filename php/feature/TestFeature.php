...
// Radiorecord SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RadiorecordTestFeature extends RadiorecordBaseFeature
{
    ...
    public function init(RadiorecordContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RadiorecordContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = RadiorecordParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RadiorecordContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RadiorecordContext $ctx, $op, $args): array
    {
