...
// Radiorecord SDK ratelimit feature
...
class RadiorecordRatelimitFeature extends RadiorecordBaseFeature
{
    ...
    private function _acquire(RadiorecordContext $ctx): void
    {
    ...
    private function _track(RadiorecordContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
