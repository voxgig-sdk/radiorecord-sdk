...
// Radiorecord SDK telemetry feature
...
class RadiorecordTelemetryFeature extends RadiorecordBaseFeature
{
    ...
    private function _close(RadiorecordContext $ctx, bool $ok): void
    {
