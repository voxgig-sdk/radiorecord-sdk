...
|---|---|---|
| `ts/` | @voxgig-sdk/radiorecord-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/radiorecord-sdk \
      --repository voxgig-sdk/radiorecord-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/radiorecord-sdk` shows it, and
`npm trust revoke @voxgig-sdk/radiorecord-sdk --id=<id>` removes it.
