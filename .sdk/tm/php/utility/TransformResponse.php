...
// Radiorecord SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class RadiorecordTransformResponse
{
    public static function call(RadiorecordContext $ctx): mixed
    {
        ...
        $transform = RadiorecordHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
