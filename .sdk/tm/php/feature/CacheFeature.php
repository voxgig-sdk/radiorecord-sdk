...
class RadiorecordCacheFeature extends RadiorecordBaseFeature
{
    ...
    private function _through(RadiorecordContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
