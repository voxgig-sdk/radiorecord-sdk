...
// Radiorecord SDK metrics feature
...
class RadiorecordMetricsFeature extends RadiorecordBaseFeature
{
    ...
    private function _record(RadiorecordContext $ctx, bool $ok): void
    {
