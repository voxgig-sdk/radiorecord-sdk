...
// Radiorecord SDK streaming feature
...
class RadiorecordStreamingFeature extends RadiorecordBaseFeature
{
    ...
    private function _iterate(RadiorecordResult $result): \Generator
    {
    ...
    private function _streamable(RadiorecordContext $ctx): bool
    {
