...
class RadiorecordProxyFeature extends RadiorecordBaseFeature
{
    ...
    public function init(RadiorecordContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RadiorecordContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
