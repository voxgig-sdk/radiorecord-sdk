...
// Radiorecord SDK netsim feature
...
class RadiorecordNetsimFeature extends RadiorecordBaseFeature
{
    ...
    private function _simulate(RadiorecordContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RadiorecordContext $ctx, array $applied): void
    {
        $client = $this->client;
