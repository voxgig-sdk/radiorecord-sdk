...
class RadiorecordRbacFeature extends RadiorecordBaseFeature
{
    ...
    private function _required(RadiorecordContext $ctx): ?string
    {
    ...
    private function _reject(RadiorecordContext $ctx, string $required): void
    {
    ...
    private function _track(RadiorecordContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
