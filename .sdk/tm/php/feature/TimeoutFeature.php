...
// Radiorecord SDK timeout feature
...
class RadiorecordTimeoutFeature extends RadiorecordBaseFeature
{
    ...
    private function _with_timeout(RadiorecordContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RadiorecordContext $_ctx, float $ms): void
    {
        $client = $this->client;
