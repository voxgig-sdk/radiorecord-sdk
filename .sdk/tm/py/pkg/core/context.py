...
from projectname_sdk.core.control import RadiorecordControl
...
class RadiorecordContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, RadiorecordSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RadiorecordResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RadiorecordResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RadiorecordError(code, msg, self)
