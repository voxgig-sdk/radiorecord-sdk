...
from projectname_sdk import RadiorecordSDK
from projectname_sdk.core.spec import RadiorecordSpec
from projectname_sdk.core.result import RadiorecordResult
from projectname_sdk.core.response import RadiorecordResponse
from projectname_sdk.core.operation import RadiorecordOperation
from projectname_sdk.core.error import RadiorecordError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import RadiorecordBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return RadiorecordError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = RadiorecordSDK.test(None, None)
        ...
        class TestInitFeature(RadiorecordBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(RadiorecordBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = RadiorecordSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = RadiorecordSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = RadiorecordOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = RadiorecordSDK.test(None, setup_opts)
