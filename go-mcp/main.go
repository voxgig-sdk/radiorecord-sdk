// Command Radiorecord-mcp is an MCP server exposing the Radiorecord
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Radiorecord_list  — list records of an entity
//	Radiorecord_load  — load a single record of an entity
//
