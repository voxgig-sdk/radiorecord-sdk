...
type Args struct {
	Entity string         `json:"entity" jsonschema:"chart"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RadiorecordSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "radiorecord_list",
		Description: "List records from Radiorecord. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "radiorecord_load",
		Description: "Load a single record from Radiorecord. " +
...
func runOp(client *sdk.RadiorecordSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RadiorecordSDK, name string) (sdk.RadiorecordEntity, error) {
	switch strings.ToLower(name) {
	case "chart":
		return client.Chart(nil), nil
