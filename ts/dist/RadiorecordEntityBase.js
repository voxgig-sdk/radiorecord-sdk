...
exports.RadiorecordEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends RadiorecordEntityBase<Advice>`.
class RadiorecordEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.RadiorecordEntityBase = RadiorecordEntityBase;
//# sourceMappingURL=RadiorecordEntityBase.js.map