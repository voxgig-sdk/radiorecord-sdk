# Radiorecord TypeScript SDK Reference

Complete API reference for the Radiorecord TypeScript SDK.
...
```ts
new RadiorecordSDK(options?: object)
```
...
#### `RadiorecordSDK.test(testopts?, sdkopts?)`
...
**Returns:** `RadiorecordSDK` instance in test mode.
...
Return the parent `RadiorecordSDK` instance.
