...
function envOverride(m) {
    if ('TRUE' === process.env.RADIORECORD_TEST_LIVE ||
        'TRUE' === process.env.RADIORECORD_TEST_OVERRIDE) {
    ...
    m.RADIORECORD_TEST_EXPLAIN = process.env.RADIORECORD_TEST_EXPLAIN || m.RADIORECORD_TEST_EXPLAIN;
    return m;
}
