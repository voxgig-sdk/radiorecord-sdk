...
#      offline in seeded test mode (RadiorecordSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Radiorecord_sdk.rb")
  SDK_CLASS = "RadiorecordSDK"
