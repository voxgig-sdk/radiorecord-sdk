...
module RadiorecordTestRunner
  ...
  def self.env_override(m)
    live = getenv("RADIORECORD_TEST_LIVE")
    override = getenv("RADIORECORD_TEST_OVERRIDE")
    ...
    explain = getenv("RADIORECORD_TEST_EXPLAIN")
    m["RADIORECORD_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = RadiorecordTestRunner
Helpers = RadiorecordHelpers
Vs = VoxgigStruct
