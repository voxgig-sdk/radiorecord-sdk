...
function runner.env_override(m)
  local live = runner.getenv("RADIORECORD_TEST_LIVE")
  local override = runner.getenv("RADIORECORD_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("RADIORECORD_TEST_EXPLAIN")
