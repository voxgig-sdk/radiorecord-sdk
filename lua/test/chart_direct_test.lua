...
describe("ChartDirect", function()
  it("should direct-list-chart", function()
    local setup = chart_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-chart", setup.live and "live" or "unit")
