...
Results: Successfully retrieved club chart.
...
| --- | --- | --- | --- |
| Chart | `list` | `GET /api/chart/club` | See reference |

## Connect to the API

- Radiorecord API server: `https://www.radiorecord.ru`
...
- `radiorecord_list`: List records for an entity. Supported entities: `chart`.
- `radiorecord_load`: Load one record for an entity. No active entity supports this operation.
