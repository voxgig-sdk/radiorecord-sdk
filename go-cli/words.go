...
func registerSDKWords(r *eng.Registry, client *sdk.RadiorecordSDK) {
...
func runOp(client *sdk.RadiorecordSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
