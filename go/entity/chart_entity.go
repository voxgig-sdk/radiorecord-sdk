...
func NewChartEntity(client *core.RadiorecordSDK, entopts map[string]any) *ChartEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ChartEntity) GetName() string { return e.name }
...
func (e *ChartEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ChartEntity) Deleted() bool {
	return e.deleted
}


func (e *ChartEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewChartEntity(e.client, opts)
}

func (e *ChartEntity) Data(args ...any) any {
...
func (e *ChartEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Chart; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ChartEntity) DataTyped(data ...Chart) Chart {
	if len(data) > 0 {
		return typedFrom[Chart](e.Data(asMap(data[0])))
	}
	return typedFrom[Chart](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Chart (all fields
// optional at the wire level).
func (e *ChartEntity) MatchTyped(match ...Chart) Chart {
	if len(match) > 0 {
		return typedFrom[Chart](e.Match(asMap(match[0])))
	}
	return typedFrom[Chart](e.Match())
}
...
func (e *ChartEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ChartEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ChartEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ChartListMatch and returns []Chart. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ChartEntity) ListTyped(reqmatch ChartListMatch, ctrl map[string]any) ([]Chart, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Chart](res), nil
}



func (e *ChartEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ChartEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ChartEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ChartEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
