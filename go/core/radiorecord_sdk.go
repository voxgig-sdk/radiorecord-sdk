...
func (sdk *RadiorecordSDK) OptionsMap() map[string]any {
...
func (sdk *RadiorecordSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RadiorecordSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RadiorecordSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RadiorecordSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RadiorecordSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RadiorecordSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RadiorecordSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RadiorecordSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RadiorecordSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RadiorecordSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
