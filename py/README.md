# Radiorecord Python SDK



The Python SDK for the Radiorecord API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Chart()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/radiorecord-sdk/releases)) or
