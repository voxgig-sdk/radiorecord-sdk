# Radiorecord SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RadiorecordSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RadiorecordSDK(...) and RadiorecordSDK.test(...) become
#      RadiorecordSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "radiorecord_sdk"
_SDK_CLASS = "RadiorecordSDK"
